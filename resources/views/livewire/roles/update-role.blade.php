            ...
            <div class="grid gap-8">
                ...
                <div class="grid md:grid-cols-3 gap-4">
                    ...
                    <div class="flex flex-col md:space-y-2">
                        <legend class="uppercase tracking-wide text-base">{{__('Sobre el cargo')}}</legend>
                        <p class="text-sm font-light">{{__('Informacióm asociada al cargo')}}</p>
                    </div>
                ...
                <div class="grid md:grid-cols-3 gap-4">
                    <div class="flex flex-col md:space-y-2">
                        <legend class="uppercase tracking-wide text-base">{{__('Permisos asociados al cargo')}}</legend>
                        <p class="text-sm font-light">{{__('Seleccione los permisos que quiere adjuntar al cargo')}}</p>
                        <p class="text-sm font-light">{{__('Numero de permisos del cargo')}}: {{ count($permisos_ids) }} </p>
                    </div>
