<div class="flex flex-col justify-between items-center h-screen-nav">
    ...
    <section class="w-full md:w-9/12 lg:w-8/12 px-6 sm:px-12">
        ...
        <p class="font-bold mb-1">Asesoramiento web en PHP y Laravel</p>
    </section>
    <div class="my-6">
        <p class="font-bold mb-1">Un buen sistema se valida en sus de<b class="text-blue-800 dark:text-blue-400">tall</b>es...</p>
    </div>
    <footer class="w-full md:w-9/12 lg:w-8/12 p-6 sm:p-12 text-xs flex flex-col items-end">
        <a href="#">Juan Carlos Marchant (FullStack Developer)</a>
